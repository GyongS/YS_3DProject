...
void CMainApp::InitStaticPrototype(void)
{
	...
	pCamera->AddComponent<Engine::CTransformComponent>()->SetPosition(_float3(0, 0, 0));
	pCamera->GetComponent<Engine::CTransformComponent>()->SetRotationY(180);
	...
	pPlayer->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CSphereCollider::Create(1.f));
	Engine::CObjectFactory::GetInstance()->AddPrototype(pPlayer);

	SHARED(Engine::CGameObject) pWalkBlock = Engine::CGameObject::Create(L"Player", L"WalkBlock", true);
	pWalkBlock->AddComponent<CWalkBlockComponent>();
	pWalkBlock->AddComponent<Engine::CMeshComponent>();
	pWalkBlock->AddComponent<Engine::CTextureComponent>();
	pWalkBlock->AddComponent<Engine::CTransformComponent>();
	pWalkBlock->AddComponent<Engine::CGraphicsComponent>();
	pWalkBlock->AddComponent<Engine::CRigidBodyComponent>()->SetMass(5.0f);
	pWalkBlock->GetComponent<Engine::CRigidBodyComponent>()->SetBounciness(0.5);
	pWalkBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CObbCollider::Create(_float3(0.5f, 1.f, 0.5f), FLOAT3_ZERO));
	Engine::CObjectFactory::GetInstance()->AddPrototype(pWalkBlock);
}
...
void CMainApp::BlockPrototype()
{
	...
	pWhiteBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CObbCollider::Create(FLOAT3_ONE, FLOAT3_ZERO));
	...
	pBlueBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CObbCollider::Create(FLOAT3_ONE, FLOAT3_ZERO));
	...
	pRedBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CObbCollider::Create(_float3(1.f, 3.f, 1.f), FLOAT3_ZERO));
	...
	pYellowBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CObbCollider::Create(_float3(1.f, 3.f, 1.f), FLOAT3_ZERO));
	...
	pGreenBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CSphereCollider::Create(0.8f, FLOAT3_ZERO));
	...
	pRhythmBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CObbCollider::Create(_float3(0.3f, 1.f, 0.3f), FLOAT3_ZERO));
	...
	pMoveBlock->AddComponent<Engine::CColliderComponent>()->AddCollider(Engine::CObbCollider::Create(_float3(1.f, 1.f, 1.f), FLOAT3_ZERO));
